                    ...
                    <div class="row">
                        ...
                        <form action="verArqueo.php" method="post" name="formDatos">
                            ...
                            <form action="verArqueo.php" method="post" name="formDatos">
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El punto de venta tiene puerta cerrada con candado y/o seguro?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿Tiene elementos de aseo, sillas en buen estado?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿Tiene aviso de videovigilancia y camaras?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El Colocador cuenta con prendas emblematicas y presentación adecuada?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El usuario del colocador corresponde a la cedula del mismo?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿La versión del aplicativo BNET esta actualizada?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El colocador ofrece los productos y servicios comercializados por la empresa al 100%?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿La publicidad exhibida en el punto de venta se encuentra actualizada?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El colocador solicita el documento de identificación al cliente?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El uso del sistema biométrico esta activo?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El colocador conoce de Supervoucher, y esta en funcionamiento?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El Colocador conoce el procedimiento que debe realizar a remitentes y destinatarios menores de edad?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El colocador conoce los reportes de operaciones en efectivo (R.O.E) firmas, huellas. (Transacciones &gt;=$10.000.000)?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿Tiene aviso externo que indica Vigilado y Controlado Mintic y Colaborador Autorizado?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿Tiene cuadro Banner con la marca SuperGIROS (aviso de canales de comunicación)?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿Tiene afiche normativo visible o tarifario con las condiciones del servicio? </label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿Cuenta con sticker tirilla electronica CRC?"</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿Tiene normativa Giros Internacionales, camara o lector five y Sticker de pagos internacionales?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El Supervisor Comercial realiza las visitas constantemente, da buen trato y suministra los insumos a tiempo? Cantidad de visitas del Supervisor Comercial al mes?</label>
                                    <?php echo "<input class='form-control'  disabled value='" . $row["requisito9"] . "' name='año_lanzamiento' type='text' pattern='[a-zA-ZÀ-ÿ\u00f1\u00d1\0-9 ]{0,120}'>"; ?>
                                </div>
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿Las recargas efectuadas por el Colocador se trasmiten a través de la red propia de la empresa?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿La lotería física tiene impreso el nombre de la empresa, de no ser asi reportar inmediatamente?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El punto de venta tiene caja fuerte y caja digital? el responsable tiene conocimiento sobre las bases de efectivo asignadas para caja auxiliar y caja digital?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿Se cumple con los topes de efectivo establecidos para la caja digital y caja auxiliar (ptos de venta con giros)?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El colocador tiene conocimiento sobre los montos máximos para pago de premios?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El colocador conoce los requisitos para pago de premios?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿Tiene buzon de PQR, formato de gane y de giros? </label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El Colocador cuenta con las bases acerca del SARL, SARLAFT, SARO?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>¿El Colocador conoce la definición de operación inusual y operación sospechosa?</label>
                                ...
                                <div class="form-group col-md-4">
                                    <label>VERIFICACION INSUMOS PARA PREVENCION DE COVID 19</label>
